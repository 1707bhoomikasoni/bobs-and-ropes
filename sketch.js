...
chain=new Rope(bobObject1.body,ground1.body,30*-2,0)
chain2=new Rope(bobObject2.body,ground1.body,30*-1,0)
chain3=new Rope(bobObject3.body,ground1.body,0,0)
chain4=new Rope(bobObject4.body,ground1.body,30*1,0)
chain5=new Rope(bobObject5.body,ground1.body,30*2,0)
}
